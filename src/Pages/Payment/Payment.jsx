...
//   // Updated handlePaymentSuccess function to save orders to database
// const handlePaymentSuccess = async (response) => {
//   try {
//     // Verify payment on backend
//     const { data } = await axios.post(`${PAYMENT_URL}/verify`, {
...
//       description: error.response?.data?.message || error.message || "Could not process your order",
//       status: "error",
//       duration: 5000,
//       isClosable: true,
//     });
...
// // Helper function to calculate estimated delivery date (7 days from now)
// const getEstimatedDeliveryDate = () => {
//   const date = new Date();
//   date.setDate(date.getDate() + 7);
//   return date.toISOString(); // Return ISO string for database
// };

// Updated handlePaymentSuccess function with better error handling
const handlePaymentSuccess = async (response) => {
  setLoading(true);
