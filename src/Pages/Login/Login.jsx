...
// import { cartReset } from "../../redux/CartPage/action"; // Add this import
...
// // In your Login.js, add to the getData function after successful login:
// const getData = async () => {
//   try {
//     setLoading(true);
//     setinCorrect(false);
...
//         try {
//           const cartResponse = await axios.get(`http://localhost:5000/cart/${res1[0]._id}`);
...
const Login = ({ isOpen: externalIsOpen, onOpen: externalOnOpen, onClose: externalOnClose }) => {
  ...
  //   }
  // };
  //Login page - Updated getData function
const getData = async () => {
  try {
    setLoading(true);
    setinCorrect(false);
